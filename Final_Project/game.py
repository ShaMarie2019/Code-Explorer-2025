...
class Room(object):
    def __init__(self, name, description):      #Creating a room class that is intialized with name and description for room 
        self.name = name
...
class Player(object):
    def __init__(self, name, location):     #create a player class that initializes with name of character and locations 
        self.name = name
        self.location = location
        self.inventory = []                    #on initialization creates an empty inventory list

class Item(object):
    def __init__(self, name, description, is_movable):      #create an item classs to name items with descptions and whether or not they can move
        self.name = name
        self.description = description
